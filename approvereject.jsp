...
<%
   try{
       Class.forName("com.mysql.jdbc.Driver");
        ...
        ResultSet rs = st.executeQuery("select * from faculty where fflag=0");
        ...
        while(rs.next())
        {
            ...
            out.println("<td><a href=approvefaculty.jsp?srno="+p+">Approve</a>");
            out.println("<td><a href=rejectfaculty.jsp?srno="+p+">Reject</a>");
